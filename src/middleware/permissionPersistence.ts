...
const permissionPersistenceMiddleware: Middleware<unknown, TabPageRootState, Dispatch<Action>> = (store) => (next) => (action: unknown) => {
...
export default permissionPersistenceMiddleware;