...
export default function AdminUpdateModalForm({
    adminFormData,
    ...props
}: AdminModalFormProps) {
    ...
    useEffect(() => {
        const strKey = adminFormData.permissionKey as string[];

        form.setFieldsValue({
            ...adminFormData,
            permissionKey: strKey
        });
    ...
    const handlerReset = () => {
        ...
        setDefaultCheckedKeys(adminFormData.permissionKey as string[]);
    }
    return (
        <ModalForm<AdminUpdate>
            name="AdminUpdate"
            form={form}
