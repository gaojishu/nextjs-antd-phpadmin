import type { PermissionRecord, PermissionUpdate } from '@/types';
import {
    ModalForm,
    ProForm,
    ProFormDigit,
...
type PermissionModalFormProps = ModalFormProps<PermissionUpdate> &
{ permissionTreeData: PermissionRecord[] } &
{ permissionFormData: PermissionUpdate };
